...
public class MemberService {
    ...
    public MemberDto.MemberResponseDto createMember(MemberDto.MemberPostDto memberPostDto) {
        if(!memberRepository.existsByUsername(memberPostDto.getMemberUsername())){
            memberPostDto.setMemberPassword(bCryptPasswordEncoder.encode(memberPostDto.getMemberPassword()));
